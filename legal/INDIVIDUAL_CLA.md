...
**Project:** @plasius/graph-runtime-azure-functions (Plasius LTD)  
...
- **"Project"** means the @plasius/graph-runtime-azure-functions repositories and related materials owned or managed by **Plasius LTD**.
